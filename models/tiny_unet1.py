# Based on https://github.com/ChenJunren-Lab/TinyU-Net/blob/main/TinyU-Net.py 
import torch
...
class TinyUNet(nn.Module):
    ...
    '''
    def __init__(self, in_channels=3, num_classes=2, name='tinyunet', learn_gray=False):
        super(TinyUNet, self).__init__()
        self.learn_gray = learn_gray
        if self.learn_gray:
            self.name = name + '_learn_gray'
        else:
            self.name = name
