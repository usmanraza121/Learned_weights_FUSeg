...
if __name__ == "__main__":
    img = Image.open("data/Foot Ulcer Segmentation Challenge/validation/images/0005.png")
    img.show(title='Source')
    to_pil(stretch(from_pil(img))).show(title='Stretch')
    to_pil(grey_world(from_pil(img))).show(title='GrayWorld')
